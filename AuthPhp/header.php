...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous"><nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container" style="width: 900px; height: 50px; background: yellow">
    <a class="navbar-brand" href="/footer.php/">Menu</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="/form.php/">Registration</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/body.php/">Main</a>
        </li>
      </ul>
    </div>
  </div>
